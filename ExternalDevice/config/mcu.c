...
void Serial_printf(char * pui8String, tNFCHostCommands eCmdType)
{
	...
	//{
		...
		//USBCDC_sendDataInBackground((BYTE *)pui8Packet,3,CDC0_INTFNUM,0);
		 		 */

		//send the chars from buf
	    pui8Packet[0] = 0x0A;
	    strcat(pui8String, pui8Packet);
		USBCDC_sendDataInBackground((BYTE *)pui8String,strlen(pui8String),CDC0_INTFNUM,1000);
