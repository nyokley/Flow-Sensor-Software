...
#define BRIDGE_VCC_DIR_OUT GPIO_setAsOutputPin(BRIDGE_VCC_PORT, BRIDGE_VCC);
#define BRIDGE_VCC_ON      GPIO_setOutputHighOnPin(BRIDGE_VCC_PORT, BRIDGE_VCC);
#define BRIDGE_VCC_OFF     GPIO_setOutputLowOnPin(BRIDGE_VCC_PORT, BRIDGE_VCC);

#define LEDR_DIR_OUT PJDIR |=BIT0
#define LEDR_ON      PJOUT |=BIT0
#define LEDR_OFF     PJOUT &= ~BIT0

#define LEDG_DIR_OUT PJDIR |=BIT1
#define LEDG_ON      PJOUT |=BIT1
#define LEDG_OFF     PJOUT &= ~BIT1

#define LEDB_DIR_OUT PJDIR |=BIT2
#define LEDB_ON      PJOUT |=BIT2
#define LEDB_OFF    PJOUT &= ~BIT2
...
//#define SENSOR_PORT_SET       FIXME P6.3
