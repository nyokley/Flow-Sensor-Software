...
// TRF79790A Hardware Configuration
//
#define SPI_MODULE_BASE_ADDR 	USCI_B1_BASE
#define SPI_PORT 				GPIO_PORT_P4
#define SPI_CLK 				GPIO_PIN3
#define SPI_MOSI 				GPIO_PIN1
#define SPI_MISO 				GPIO_PIN2
#define SPI_SS_PORT				GPIO_PORT_P7
#define SPI_SS_POUT				P7OUT
#define SPI_SS 					GPIO_PIN7
#define TRF_EN_PORT				GPIO_PORT_P3
#define TRF_EN 					GPIO_PIN7

#define BRIDGE_VCC_PORT         GPIO_PORT_P3
#define BRIDGE_VCC_SETDIR       P3DIR |= BIT5
#define BRIDGE_VCC_POUT         P3OUT
#define BRIDGE_VCC              GPIO_PIN5
#define BRIDGE_VCC_HIGH         P3OUT |= BIT5
#define BRIDGE_VCC_LOW          P3OUT &= BIT5

#define TRF_IRQ_PORT 			GPIO_PORT_P1
#define TRF_IRQ_PIN				P1IN
#define TRF_IRQ 				GPIO_PIN0
